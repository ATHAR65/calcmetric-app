...
export const metadata = {
  ...
  alternates: {
    canonical: "/blog/doordash-tax-estimator-2026",
  },
};
...
export default function DoorDashBlog() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://themetricapp.com/blog/doordash-tax-estimator-2026",
    },
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Blog", item: "https://themetricapp.com/blog" },
      {
        ...
        item: "https://themetricapp.com/blog/doordash-tax-estimator-2026",
      },
    ],
  };
