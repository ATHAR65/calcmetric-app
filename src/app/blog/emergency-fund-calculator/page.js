...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/og-default.svg", width: 1200, height: 630, alt: "Emergency Fund Calculator 2026" }],
  },
  twitter: {
...
export default function EmergencyFundBlog() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://themetricapp.com/blog/emergency-fund-calculator",
    },
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Blog", item: "https://themetricapp.com/blog" },
      {
        ...
        item: "https://themetricapp.com/blog/emergency-fund-calculator",
      },
    ],
  };
      ...
      <div className="prose prose-slate max-w-none prose-headings:text-[#0F172A] prose-headings:font-extrabold prose-headings:tracking-tight prose-h2:text-2xl prose-h2:mt-12 prose-h2:mb-4 prose-h3:text-xl prose-h3:mt-8 prose-h3:mb-3 prose-p:text-[#475569] prose-p:leading-relaxed prose-a:text-[#6366F1] prose-a:font-medium hover:prose-a:text-[#4F46E5] prose-strong:text-[#0F172A] prose-ul:text-[#475569] prose-ol:text-[#475569] prose-li:leading-relaxed">
        ...
        <div className="not-prose rounded-2xl border border-[#E2E8F0] bg-gradient-to-br from-[#EEF2FF] to-white p-6 my-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="font-bold text-[#0F172A] text-lg mb-1">Try the Emergency Fund Calculator Now</p>
              <p className="text-sm text-[#64748B] mb-3">Enter your monthly expenses, current savings, and income stability to get a personalized emergency fund target.</p>
              <Link href="/calculators/emergency-fund-calculator" className="inline-flex items-center gap-1.5 rounded-xl bg-[#6366F1] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#4F46E5] transition-colors shadow-sm">
