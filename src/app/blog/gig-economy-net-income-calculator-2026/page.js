...
export const metadata = {
  ...
  alternates: {
    canonical: "/blog/gig-economy-net-income-calculator-2026",
  },
  openGraph: {
    ...
    <article className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:py-16">
      ...
      <div className="bg-[#F8FAFC] dark:bg-[#1E293B] rounded-xl p-4 mb-6 border border-[#E2E8F0] dark:border-[#334155]">
        <ul className="space-y-1 text-sm text-[#475569] dark:text-[#CBD5E1]">
          ...
          <li className="text-[#0D9488] font-bold"><strong>Take-home:</strong> $15,271</li>
      ...
      <div className="bg-[#F8FAFC] dark:bg-[#1E293B] rounded-xl p-4 mb-6 border border-[#E2E8F0] dark:border-[#334155]">
        <ul className="space-y-1 text-sm text-[#475569] dark:text-[#CBD5E1]">
          ...
          <li className="text-[#0D9488] font-bold"><strong>Take-home:</strong> $23,029</li>
      ...
      <div className="bg-[#F8FAFC] dark:bg-[#1E293B] rounded-xl p-4 mb-6 border border-[#E2E8F0] dark:border-[#334155]">
        <ul className="space-y-1 text-sm text-[#475569] dark:text-[#CBD5E1]">
          ...
          <li className="text-[#0D9488] font-bold"><strong>Take-home:</strong> $29,989</li>
      ...
      <p className="text-[#475569] dark:text-[#CBD5E1] leading-relaxed mb-6">
        Open a separate savings account and automatically transfer 25-30% of each payout for taxes. Set calendar reminders for quarterly payment due dates: April 15, June 15, September 15, and January 15. Use our <Link href="/calculators/gig-economy-net-income-calculator" className="text-[#0D9488] hover:underline font-semibold">calculator</Link> to estimate your exact quarterly amount.
      </p>
      ...
      <div className="space-y-6 mb-10">
        ...
        <div>
          ...
          <p className="text-[#475569] dark:text-[#CBD5E1]">A: 25-30% of net income after expenses. Use our <Link href="/calculators/gig-economy-net-income-calculator" className="text-[#0D9488] hover:underline">calculator</Link> for exact amounts.</p>
        </div>
        <div>
      ...
      <div className="mt-12 p-6 bg-[#F0FDFA] dark:bg-[#0D9488]/10 border border-[#0D9488]/20 rounded-2xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <Link href="/calculators/doordash-tax-estimator" className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-[#475569] dark:text-[#CBD5E1] hover:text-[#0D9488] hover:bg-[#0D9488]/5 transition-colors">
            <span>🚗</span> DoorDash Tax Estimator
          </Link>
          <Link href="/calculators/uber-tax-calculator-2026" className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-[#475569] dark:text-[#CBD5E1] hover:text-[#0D9488] hover:bg-[#0D9488]/5 transition-colors">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <ul className="text-sm text-[#64748B] dark:text-[#94A3B8] leading-relaxed space-y-1 list-disc list-inside">
              <li><a href="https://www.irs.gov/taxtopics/tc751" target="_blank" rel="noopener noreferrer" className="text-[#0D9488] hover:underline">IRS Topic 751 — Self-Employment Tax</a></li>
              <li><a href="https://www.irs.gov/newsroom/irs-provides-tax-inflation-adjustments-for-tax-year-2026" target="_blank" rel="noopener noreferrer" className="text-[#0D9488] hover:underline">IRS — 2026 Standard Mileage Rate</a></li>
              <li><a href="https://www.uber.com/us/en/drive/" target="_blank" rel="noopener noreferrer" className="text-[#0D9488] hover:underline">Uber — Driver Earnings &amp; Fees</a></li>
              <li><a href="https://help.doordash.com/dashers/s/" target="_blank" rel="noopener noreferrer" className="text-[#0D9488] hover:underline">DoorDash — Dasher Pay &amp; Expenses</a></li>
              <li><a href="https://www.bls.gov/oes/current/oes_nat.htm" target="_blank" rel="noopener noreferrer" className="text-[#0D9488] hover:underline">Bureau of Labor Statistics — Wage Data</a></li>
            </ul>
