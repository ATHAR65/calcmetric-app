...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/og-default.svg", width: 1200, height: 630, alt: "National Insurance Calculator UK 2026" }],
  },
  alternates: {
    ...
    <article className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:py-16">
      ...
      <header className="mb-10">
        <div className="flex items-center gap-2 mb-4">
          <span className="inline-flex items-center rounded-full bg-[#F0FDFA] px-3 py-1 text-xs font-semibold text-[#0D9488]">Tax Tools</span>
        ...
        <div className="not-prose rounded-2xl border border-[#E2E8F0] bg-gradient-to-br from-[#F0FDFA] to-white p-6 my-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-[#64748B] mb-3">Select your employment type and enter your income to see your NI contributions in seconds.</p>
              <Link href="/calculators/national-insurance-calculator-uk"
                ...
                Open National Insurance Calculator UK
