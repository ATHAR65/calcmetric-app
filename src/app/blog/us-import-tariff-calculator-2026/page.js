...
export const metadata = {
  ...
  alternates: {
    canonical: "/blog/us-import-tariff-calculator-2026",
  },
};
    ...
    <article className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:py-16">
      ...
      <header className="mb-10">
        <div className="flex items-center gap-2 mb-4">
          <span className="inline-flex items-center rounded-full bg-[#F0FDFA] px-3 py-1 text-xs font-semibold text-[#0D9488]">Import & Trade</span>
      ...
      <div className="prose prose-slate max-w-none prose-headings:text-[#0F172A] prose-headings:font-extrabold prose-headings:tracking-tight prose-h2:text-2xl prose-h2:mt-12 prose-h2:mb-4 prose-h3:text-xl prose-h3:mt-8 prose-h3:mb-3 prose-p:text-[#475569] prose-p:leading-relaxed prose-a:text-[#0D9488] prose-a:font-medium hover:prose-a:text-[#0F766E] prose-strong:text-[#0F172A] prose-ul:text-[#475569] prose-ol:text-[#475569] prose-li:leading-relaxed">
        ...
        <div className="not-prose rounded-2xl border border-[#E2E8F0] bg-gradient-to-br from-[#F0FDFA] to-white p-6 my-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="font-bold text-[#0F172A] text-lg mb-1">Try the US Import Tariff Calculator Now</p>
              <p className="text-sm text-[#64748B] mb-3">Enter any product value, country, and category to see your exact duties and total landed cost.</p>
              <Link href="/calculators/us-import-tariff-calculator" className="inline-flex items-center gap-1.5 rounded-xl bg-[#0D9488] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#0F766E] transition-colors shadow-sm">
