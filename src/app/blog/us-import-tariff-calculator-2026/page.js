...
export const metadata = {
  ...
  alternates: {
    canonical: `${siteUrl}/blog/us-import-tariff-calculator-2026`,
  },
};
        ...
        <div className="not-prose rounded-2xl border border-[#E2E8F0] bg-gradient-to-br from-[#EEF2FF] to-white p-6 my-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <Link href="/calculators/us-import-tariff-calculator" className="inline-flex items-center gap-1.5 rounded-xl bg-[#6366F1] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#4F46E5] transition-colors shadow-sm">
