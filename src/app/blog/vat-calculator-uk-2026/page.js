...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/og-default.svg", width: 1200, height: 630, alt: "VAT Calculator UK 2026" }],
  },
  alternates: {
        ...
        <div className="not-prose rounded-2xl border border-[#E2E8F0] bg-gradient-to-br from-[#F0FDFA] to-white p-6 my-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-[#64748B] mb-3">Enter any amount to add or remove VAT instantly. Supports both 20% and 5% rates.</p>
              <Link href="/calculators/vat-calculator-uk"
