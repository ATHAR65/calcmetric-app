...
export const metadata = {
  ...
  description:
    "Calculate your California 1099 freelance taxes for 2026 — federal self-employment tax (15.3%), income tax brackets, and CA state income tax rates up to 13.3%...",
  ...
  openGraph: {
    title: "California 1099 Tax Calculator 2026 — SE & State Tax",
    description:
