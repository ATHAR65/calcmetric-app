...
export const metadata = {
  ...
  description:
    "Calculate monthly car payments, total interest, and DTI analysis. Free 2026 car affordability calculator before you visit the dealership.",
  ...
  openGraph: {
    title: "Car Loan Affordability Calculator 2026 — Can You Afford",
    description:
    "Calculate monthly car payments, total interest, and whether a car loan fits your budget. Free 2026 car affordability calculator.",
