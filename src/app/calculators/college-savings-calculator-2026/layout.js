...
export const metadata = {
  title: { absolute: "College Savings Calculator 2026 — 529 Plan | TheMetricApp" },
  description:
    "Calculate 529 plan growth, project college costs, and find your monthly savings target. Free 2026 college savings calculator with state tax deduction estimates.",
  keywords: [
