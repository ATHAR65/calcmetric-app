...
const CALC_DESCRIPTION = "Work out UK dividend tax at the new 2026/27 rates (10.75% / 35.75%) in seconds — £500 allowance and salary vs dividend planning for directors. Free.";
export const metadata = buildCalculatorMetadata({ slug: CALC_SLUG, name: CALC_NAME, description: CALC_DESCRIPTION });

const seoContent = [
  "UK dividends are taxed at rates separate from employment income. From 6 April 2026 the rates are: <strong>10.75% for basic rate</strong> taxpayers, <strong>35.75% for higher rate</strong>, and <strong>39.35% for additional rate</strong> — the basic and higher rates each rose by 2 percentage points in the 2026/27 tax year. Every individual receives a <strong>£500 dividend allowance</strong>, meaning the first £500 of dividend income is tax-free regardless of your tax band.",
...
const staticFaqs = [
  { q: "What is the UK dividend allowance in 2026/27?", a: "The dividend allowance is £500 per year for 2026/27, unchanged from 2025/26. The first £500 of dividend income is tax-free regardless of your income tax band. Any dividends above £500 are taxed at 10.75% (basic), 35.75% (higher), or 39.35% (additional rate) — the basic and higher rates rose by 2 percentage points on 6 April 2026." },
  { q: "How much tax do I pay on £20,000 of dividends?", a: "It depends on your other income. If you have a salary of £12,570 (using the personal allowance), £20,000 of dividends falls within the basic rate band. Tax = (£20,000 − £500 allowance) × 10.75% = £2,096. If you earn £50,000 salary, the dividends push into the higher rate band: tax is approximately £6,971." },
  { q: "Are dividends taxed twice in the UK?", a: "Effectively yes. The company pays 25% Corporation Tax on profits before distributing dividends. You then pay dividend tax on what you receive. On £100 of company profit, after 25% CT you receive £75, then pay dividend tax on that. The combined rate for a higher-rate taxpayer is approximately 51.8% at 2026/27 rates." },
  ...
  { q: "Are dividends in an ISA tax-free?", a: "Yes. Dividends received on shares held within a Stocks and Shares ISA are completely tax-free — no dividend tax and no capital gains tax. The annual ISA allowance is £20,000 for 2026/27. This makes ISAs extremely valuable for dividend investors, especially higher and additional rate taxpayers." },
];
