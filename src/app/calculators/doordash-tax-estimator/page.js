...
const seoContent = [
  ...
  "The biggest tax advantage for Dashers is the <strong>IRS standard mileage deduction</strong>. For 2026, you can deduct $0.725 per business mile driven. This covers gas, insurance, maintenance, and depreciation. The average full-time Dasher drives 25,000 to 35,000 miles per year, which translates to $18,125 to $25,375 in deductions. You must track miles with an app like Everlance, Stride, or the DoorDash mileage tracker to claim this deduction.",
];
...
Key Deductions:
  Mileage: Business Miles × $0.725 (2026 IRS rate)
...
const ddHowToSteps = [
  ...
  "Enter your total business miles driven while dashing (including miles to the restaurant and to the customer). The calculator applies the 2026 rate of $0.725/mile.",
...
const staticFaqs = [
  ...
  { q: "What expenses can I deduct as a DoorDash driver?", a: "The most valuable deduction is mileage: $0.725 per business mile in 2026, covering all vehicle costs. Other deductions include your phone bill (business use percentage), insulated delivery bags, car phone mounts, parking fees and tolls during deliveries, car washes, health insurance premiums (if self-employed), and a portion of your mobile data plan. You cannot deduct commuting miles from home to your first delivery." },
  ...
  { q: "Can I use the standard mileage rate and actual expenses together?", a: "No, you must choose one method per vehicle per year. The standard mileage rate ($0.725/mile in 2026) is simpler and usually better for gig drivers because it covers gas, insurance, repairs, and depreciation in one rate. The actual expense method requires tracking every receipt and is typically only better if you have a very expensive vehicle with high maintenance costs." },
