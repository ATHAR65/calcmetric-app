...
export const metadata = {
  ...
  description:
    "Calculate annual savings switching from gas to electric vehicle. Compare charging vs fuel costs. Free EV savings calculator.",
