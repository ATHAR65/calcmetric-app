...
export const metadata = {
  title: { absolute: "Freelancer Platform Fee Comparison 2026 | TheMetricApp" },
  description:
    "Compare freelancer platform fees across Upwork, Fiverr, and Toptal. Calculate your true net earnings after service fees and payment processing. Free tool.",
  ...
  openGraph: {
    title: "Freelancer Fee Comparison 2026 — Upwork vs Fiverr Fees",
    description:
