...
const seoContent = [
  ...
  "The key to maximizing gig income is aggressive expense tracking. The <strong>IRS standard mileage rate for 2026 is $0.725 per mile</strong> — a DoorDash driver logging 25,000 miles deducts $18,125, which can eliminate most or all SE tax. Other deductible expenses include phone costs (business percentage), hot bags, phone mounts, car washes, and platform-specific equipment.",
...
const gigHowToSteps = [
  ...
  "Enter your total business expenses: mileage ($0.725/mile), phone, supplies, platform fees, and other deductible costs.",
...
const staticFaqs = [
  ...
  { q: "What is the self-employment tax rate in 2026?", a: "The SE tax rate is 15.3% — composed of 12.4% for Social Security (on the first $184,500 of net SE earnings) and 2.9% for Medicare (no cap). An additional 0.9% Medicare surtax applies on SE earnings above $200,000 (single) or $250,000 (married). You can deduct half of SE tax as an adjustment to income." },
];
