...
export const metadata = {
  ...
  description:
    "Find out how much house you can afford based on your income, debts & down payment. Free home affordability calculator — Free, no signup required.",
