...
const CALC_NAME = "UK Income Tax Calculator 2026/27";
const CALC_DESCRIPTION = "Estimate your UK income tax and National Insurance for 2026-27. Covers PAYE, self-employed & dividend income with HMRC rates. Free.";
export const metadata = buildCalculatorMetadata({ slug: CALC_SLUG, name: CALC_NAME, description: CALC_DESCRIPTION });

const seoContent = [
  "The UK income tax system uses a <strong>Personal Allowance and three tax bands</strong>. For the 2026/27 tax year, the Personal Allowance is <strong>£12,570</strong> — you pay no income tax on the first £12,570 you earn. Above that, the Basic Rate is 20% on income from £12,571 to £50,270, the Higher Rate is 40% on income from £50,271 to £125,140, and the Additional Rate is 45% on income above £125,140.",
  ...
  "National Insurance contributions (NICs) add to the tax burden. Employed workers pay <strong>Class 1 NICs: 8% on earnings between £12,570 and £50,270</strong>, plus 2% on earnings above £50,270 (2026/27 rates). Self-employed workers pay Class 4 NICs: 6% on profits between £12,570 and £50,270, plus 2% above £50,270. Class 2 NICs are treated as paid automatically when profits exceed the £7,105 Small Profits Threshold.",
  "Dividend income has its own tax rates and a separate <strong>£500 tax-free dividend allowance</strong>. Above the allowance, dividends are taxed at 10.75% (basic rate), 35.75% (higher rate), or 39.35% (additional rate) — the basic and higher dividend rates rose by 2 percentage points on 6 April 2026. Company directors who pay themselves a small salary plus dividends often structure this to minimize NICs while staying within the basic rate band.",
];

const ukRateTable = {
  title: "2026/27 UK Income Tax Bands",
...
const staticFaqs = [
  { q: "What is the Personal Allowance for 2026-27?", a: "The Personal Allowance for the 2026/27 tax year is £12,570. You pay no income tax on the first £12,570 you earn. However, the allowance reduces by £1 for every £2 of income above £100,000, disappearing entirely at £125,140. The Personal Allowance has been frozen at £12,570 since 2021/22." },
  { q: "How much National Insurance do I pay?", a: "Employed workers pay Class 1 NICs: 8% on earnings between £12,570 and £50,270, and 2% on earnings above £50,270. Self-employed workers pay Class 4 NICs: 6% on profits between £12,570 and £50,270, and 2% above £50,270 — Class 2 is treated as paid automatically above £7,105 of profits. Employers also pay 15% on earnings above £5,000 (not deducted from your pay)." },
  { q: "What are the UK tax brackets for 2026-27?", a: "The three main tax bands are: Basic Rate at 20% (£12,571–£50,270), Higher Rate at 40% (£50,271–£125,140), and Additional Rate at 45% (over £125,140). Scottish taxpayers have different bands with rates from 19% to 48%. The Personal Allowance (£12,570) is tax-free." },
