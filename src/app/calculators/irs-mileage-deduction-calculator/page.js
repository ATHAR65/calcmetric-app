...
const CALC_DESCRIPTION = "Calculate your IRS mileage deduction for 2026. Business $0.70/mile, medical $0.21/mile, charity $0.14/mile. Free calculator for self-employed and gig workers.";
export const metadata = buildCalculatorMetadata({ slug: CALC_SLUG, name: CALC_NAME, description: CALC_DESCRIPTION });

const seoContent = [
  "The IRS standard mileage rate allows self-employed individuals and business owners to deduct a set amount per mile driven for business purposes. For 2026, the business mileage rate is <strong>$0.70 per mile</strong>. This rate covers all vehicle costs including gas, oil, insurance, registration, depreciation, and lease payments. It is the simplest way to claim a vehicle deduction without tracking individual expenses.",
  "The standard mileage rate changes annually based on a study of fixed and variable vehicle operating costs. The 2026 rate of $0.70/mile is up from $0.67 in 2024, reflecting increased fuel and insurance costs. For comparison: <strong>medical and moving mileage</strong> (limited to active-duty military) is $0.21/mile, and <strong>charitable mileage</strong> is $0.14/mile (set by statute, rarely changes).",
  ...
  "The mileage deduction is often the largest single tax deduction for gig workers, delivery drivers, and real estate agents. A DoorDash driver logging 30,000 business miles deducts <strong>$21,000</strong> — often enough to eliminate most or all SE tax on their earnings. A real estate agent driving 20,000 business miles deducts $14,000. The key is consistent tracking: untracked miles are lost deductions.",
];
...
const mileageRateTable = {
  ...
  rows: [
    ["Business", "$0.70", "Self-employed, business owners, Schedule C filers"],
    ["Medical", "$0.21", "Driving to/from medical appointments (itemized)"],
    ["Charitable", "$0.14", "Driving for qualified charitable organizations"],
    ["Moving (military only)", "$0.21", "Active-duty military members with PCS orders"],
  ],
};

const mileageFormula = `Mileage Deduction = Business Miles × $0.70
...
Example: 25,000 business miles at 22% bracket:
  ...
  Income tax savings = $17,500 × 22% = $3,850
  SE tax savings = $17,500 × 15.3% × 92.35% = $2,472
  Total savings = ~$6,322`;
...
const staticFaqs = [
  { q: "What is the IRS mileage rate for 2026?", a: "The standard mileage rate for business use is $0.70 per mile for 2026. Medical and military moving mileage is $0.21 per mile. Charitable mileage is $0.14 per mile (set by Congress, not the IRS). The business rate covers gas, maintenance, insurance, registration, and depreciation — you cannot claim these expenses separately if you use the standard rate." },
