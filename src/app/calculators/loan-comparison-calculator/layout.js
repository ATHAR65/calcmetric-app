...
export const metadata = {
  title: { absolute: "Loan Comparison Calculator 2026 — Compare | TheMetricApp" },
  description:
    "Compare two loans side-by-side with monthly payment, total interest, APR, and total cost. Free 2026 loan comparison calculator.",
