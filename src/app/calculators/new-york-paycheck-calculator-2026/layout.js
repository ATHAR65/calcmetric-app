...
export const metadata = {
  ...
  description:
    "Calculate your New York take-home pay after state, city, and federal taxes. Free NY paycheck estimator. No signup — Free, no signup required.",
  ...
  openGraph: {
    title: "New York Paycheck Calculator 2026 — Take-Home Pay After",
    description:
