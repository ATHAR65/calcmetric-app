...
export const metadata = {
  title: { absolute: "PayPal Fee Calculator 2026 — PayPal Fees | TheMetricApp" },
  description:
    "Calculate exact PayPal fees for any transaction type. Personal, business & international fees. Free, instant results — Free, no signup required.",
  keywords:
  ...
  openGraph: {
    title: "PayPal Fee Calculator 2026 — Instant Net Payout &",
    description:
    "Calculate exact PayPal fees for any transaction. Covers standard 3.49% + $0.49, friends and family, international, invoicing and micropayment rates. Free 202...",
