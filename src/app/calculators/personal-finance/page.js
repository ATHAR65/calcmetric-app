...
export default function PersonalFinanceHubPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Calculators", item: `${siteUrl}/calculators/personal-finance/` },
      { "@type": "ListItem", position: 3, name: "Personal Finance Calculators", item: `${siteUrl}/calculators/personal-finance/` },
    ],
  };
