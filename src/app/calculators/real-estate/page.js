    ...
    <>
      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:py-16">
        <nav className="flex items-center gap-2 text-sm text-[#C4BAB0] mb-8" style={{ fontFamily: "'Inter', sans-serif" }}>
          <Link href="/" className="hover:text-[#E8521A] transition-colors">Home</Link><span>/</span><span className="text-[#8A7F72]">Real Estate Calculators</span>
        </nav>
        <div className="text-center mb-14">
          <span className="inline-flex items-center gap-2 rounded-full bg-[#E8521A]/10 border border-[#E8521A]/20 px-4 py-1.5 text-sm font-semibold text-[#E8521A] mb-4" style={{ fontFamily: "'Outfit', sans-serif" }}>🏡 Real Estate Hub</span>
          <h1 className="text-3xl sm:text-4xl font-bold text-[#1A1410] tracking-tight mb-4" style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 800 }}>Real Estate Calculators (2026)</h1>
        ...
        <div className="mt-14 grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
          ...
          <div className="rounded-[18px] border border-[#E8E3DA] bg-white p-5">
            ...
            <p className="text-[11px] uppercase tracking-widest text-[#C4BAB0] mt-1">Markets</p>
          </div>
          <div className="rounded-[18px] border border-[#E8E3DA] bg-white p-5">
        ...
        <div className="mt-16">
          <h2 className="text-2xl font-bold text-[#1A1410] text-center mb-8" style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 700 }}>Real Estate FAQs</h2>
