...
export const metadata = {
  title: { absolute: "Rental Property ROI Calculator 2026 — ROI | TheMetricApp" },
  description:
    "Calculate rental property cap rate, cash-on-cash return, NOI, and the 1% rule. Free 2026 rental property ROI calculator for real estate investors.",
