...
const seoContent = [
  ...
  "The power of <strong>compound interest</strong> makes starting early critical. Investing $500/month starting at age 25 at 7% annual returns yields approximately <strong>$1,200,000 by age 65</strong>. Starting at 35 with the same $500/month yields only $567,500 — less than half. The decade of extra compounding nearly doubles the result.",
  "Financial advisors recommend saving <strong>15% of gross income</strong> for retirement (including employer match). The 2026 401(k) contribution limit is <strong>$24,500</strong> ($32,500 if age 50+). IRA limits are $7,500 ($8,600 if 50+). Maximizing tax-advantaged accounts before taxable investing ensures the most tax-efficient growth.",
...
const staticFaqs = [
  ...
  { q: "What is a good retirement savings rate?", a: "Financial advisors recommend saving 15% of gross income for retirement, including employer 401(k) match. If your employer matches 4%, save at least 11% yourself. If you started late (after 35), aim for 20–25%. The 2026 401(k) limit is $24,500 ($32,500 age 50+) and IRA limit is $7,500 ($8,600 age 50+)." },
  ...
  { q: "Should I prioritize 401(k) or IRA?", a: "Contribute to your 401(k) up to the employer match first (it is free money). Then max out a Roth IRA ($7,500 for 2026) for tax-free growth. Then return to the 401(k) and contribute up to the $24,500 limit. After maxing both, use taxable brokerage accounts. This order maximizes tax-advantaged space and employer benefits." },
];
