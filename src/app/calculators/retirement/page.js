...
export default function RetirementHubPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Calculators", item: `${siteUrl}/calculators/retirement/` },
      { "@type": "ListItem", position: 3, name: "Retirement Calculators", item: `${siteUrl}/calculators/retirement/` },
    ],
  };
