    ...
    <>
      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:py-16">
        <nav className="flex items-center gap-2 text-sm text-[#928fab] mb-8" style={{ fontFamily: "var(--font-body)" }}>
          <Link href="/" className="hover:text-[#7c3aed] transition-colors">Home</Link><span>/</span><span className="text-[#5d5a78]">Retirement Calculators</span>
        </nav>
        <div className="text-center mb-14">
          <span className="inline-flex items-center gap-2 rounded-full bg-[#7c3aed]/10 border border-[#7c3aed]/20 px-4 py-1.5 text-sm font-semibold text-[#7c3aed] mb-4" style={{ fontFamily: "var(--font-heading)" }}>🏦 Retirement Hub</span>
          <h1 className="text-3xl sm:text-4xl font-bold text-[#1d1a33] tracking-tight mb-4" style={{ fontFamily: "var(--font-heading)", fontWeight: 800 }}>Retirement Calculators (2026)</h1>
        ...
        <div className="mt-14 grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
          ...
          <div className="rounded-[18px] border border-[var(--color-border)] bg-[var(--color-bg-secondary)] p-5">
            <p className="text-2xl font-extrabold text-[#7c3aed]" style={{ fontFamily: "var(--font-heading)" }}>$70k</p>
            <p className="text-[11px] uppercase tracking-widest text-[#928fab] mt-1">Max 401(k)+Match</p>
          </div>
          <div className="rounded-[18px] border border-[var(--color-border)] bg-[var(--color-bg-secondary)] p-5">
            <p className="text-2xl font-extrabold text-[#7c3aed]" style={{ fontFamily: "var(--font-heading)" }}>4%</p>
            <p className="text-[11px] uppercase tracking-widest text-[#928fab] mt-1">Safe Withdrawal Rate</p>
          </div>
          <div className="rounded-[18px] border border-[var(--color-border)] bg-[var(--color-bg-secondary)] p-5">
        ...
        <div className="mt-16">
          <h2 className="text-2xl font-bold text-[#1d1a33] text-center mb-8" style={{ fontFamily: "var(--font-heading)", fontWeight: 700 }}>Retirement Planning FAQs</h2>
