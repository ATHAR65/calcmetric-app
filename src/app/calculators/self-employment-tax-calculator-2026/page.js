...
SE Tax = Taxable SE Base × 15.3%
  → Social Security = Taxable SE Base × 12.4% (up to $176,100)
...
const seRateTable = {
  ...
  rows: [
    ["Social Security", "12.4%", "$176,100", "Only applies up to the wage base"],
...
const seHowToSteps = [
  ...
  "Enter your business deductions — home office, supplies, mileage ($0.70/mile in 2026), phone, internet, health insurance premiums, and retirement contributions.",
...
const staticFaqs = [
  { q: "What is the self-employment tax rate in 2026?", a: "The self-employment tax rate is 15.3% of net self-employment earnings, consisting of 12.4% for Social Security (on the first $176,100) and 2.9% for Medicare (on all earnings). Before applying this rate, you multiply your net income by 92.35% to get the taxable base." },
  ...
  { q: "What expenses reduce my self-employment tax?", a: "Any legitimate business expense that reduces net profit also reduces SE tax. Common deductions include the home office deduction, vehicle mileage ($0.70/mile in 2026), health insurance premiums, retirement contributions (SEP-IRA up to $69,000, Solo 401k up to $69,000), business supplies, software, and professional development." },
];
