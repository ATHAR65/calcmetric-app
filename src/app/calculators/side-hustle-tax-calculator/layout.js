...
export const metadata = {
  ...
  description:
    "Calculate taxes on your side hustle income instantly. Covers SE tax, deductions & quarterly payments. Free tool — Free, no signup required.",
