...
const seoContent = [
  ...
  "Common deductible side hustle expenses include: home office (simplified method: $5/sq ft, max 300 sq ft = $1,500), internet and phone (business percentage), supplies and equipment, software subscriptions, mileage ($0.70/mile in 2026), professional development, and health insurance premiums if not covered by your employer. Keep receipts and separate business transactions in a dedicated bank account.",
];
