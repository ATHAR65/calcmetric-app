...
const seoContent = [
  ...
  "The Solo 401(k) has two contribution components. The <strong>employee deferral</strong> allows up to $24,500 in 2026 (or $32,500 if age 50+). The <strong>employer profit-sharing contribution</strong> allows up to 25% of net self-employment income (after the SE tax deduction). Combined, the total cannot exceed <strong>$72,000</strong> ($80,000 with catch-up for age 50+).",
  "Under <strong>SECURE 2.0</strong>, workers aged 60–63 qualify for a <strong>super catch-up contribution</strong> starting in 2025. This allows an additional catch-up amount greater than the standard $8,000 — up to $11,250 for 2026. This means self-employed individuals aged 60–63 can defer up to $35,750 as their employee contribution alone.",
...
const soloRateTable = {
  ...
  rows: [
    ...
    ["Total Maximum", "$72,000", "$80,000", "$72,000"],
    ["Roth Employee Deferral", "$24,500", "$32,500", "$35,750"],
  ],
};

const soloFormula = `Employee Deferral = Up to $24,500 ($32,500 if 50+, $35,750 if 60-63)
Employer Contribution = Net SE Income × 92.35% × 20%
  (Equivalent to 25% of net income after SE tax deduction)
Total = Employee + Employer (capped at $72,000 or $80,000)

Example on $120,000 net SE income:
  Adjusted = $120,000 × 92.35% = $110,820
  Employer = $110,820 × 20% = $22,164
  Total = $24,500 + $22,164 = $46,664`;
...
const staticFaqs = [
  { q: "What is the Solo 401(k) contribution limit in 2026?", a: "The total contribution limit is $72,000 for 2026 ($80,000 with standard catch-up for age 50+). This consists of up to $24,500 in employee deferrals plus up to 25% of net self-employment income as employer profit-sharing. Workers aged 60–63 qualify for the SECURE 2.0 super catch-up, allowing employee deferrals up to $35,750." },
  ...
  { q: "Can I have a Solo 401(k) and a regular 401(k)?", a: "Yes, but the employee deferral limit ($24,500) is a combined limit across all 401(k) plans. If you defer $15,000 to your employer's 401(k), you can only defer $9,500 more to your Solo 401(k). However, the employer contribution limits are separate — your Solo 401(k) employer contribution is based on your self-employment income regardless of your W-2 plan." },
  { q: "What is the SECURE 2.0 super catch-up?", a: "Starting in 2025, SECURE 2.0 allows workers aged 60 to 63 to make enhanced catch-up contributions. For 2026, the super catch-up amount is $11,250 (instead of the standard $8,000), allowing total employee deferrals of $35,750. This provision is temporary — it only applies during the 4-year window when you are ages 60–63. At age 64, you revert to the standard catch-up." },
  { q: "Solo 401(k) vs SEP-IRA — which is better?", a: "The Solo 401(k) is almost always better. Both allow 25% employer contributions (same dollar amount), but only the Solo 401(k) offers the additional employee deferral of $24,500. On $80,000 net SE income, a SEP-IRA maxes at ~$14,870, while a Solo 401(k) allows $14,870 + $24,500 = $39,370. The Solo 401(k) also offers Roth contributions and loan provisions." },
