...
const seoContent = [
  ...
  "The <strong>IRS standard mileage deduction</strong> is the most valuable write-off for Uber drivers. At $0.70 per mile in 2026, a driver logging 30,000 business miles deducts $21,000. This covers gas, insurance, maintenance, depreciation, and lease payments. You must keep a mileage log — the IRS requires the date, destination, business purpose, and miles for each trip. Apps like Everlance, Stride, and Gridwise track automatically.",
...
const staticFaqs = [
  ...
  { q: "Can Uber drivers deduct mileage?", a: "Yes. The 2026 IRS standard mileage rate is $0.70 per business mile. This covers all vehicle costs — gas, insurance, maintenance, depreciation, and lease payments. Business miles include driving to pickups, during rides, between requests while online, and driving for Uber Eats deliveries. Commuting from home to your first ride is not deductible. You must maintain a written mileage log." },
