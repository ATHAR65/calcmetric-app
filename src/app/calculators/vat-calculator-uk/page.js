...
const seoContent = [
  ...
  "You must register for VAT if your taxable turnover exceeds <strong>£90,000 in any rolling 12-month period</strong> (the 2026/27 threshold). You can also register voluntarily below this threshold, which allows you to reclaim VAT on business purchases. Voluntary registration makes sense if you sell primarily to VAT-registered businesses (they can reclaim the VAT you charge) or if your input VAT exceeds your output VAT.",
