    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:py-16">
      ...
      <section className="mb-12">
        ...
        <div className="rounded-2xl border border-[#E2E8F0] bg-white p-6 sm:p-8 shadow-sm">
          ...
          <p className="text-[#475569] leading-relaxed mb-4">
            <a href="/authors/" className="text-[#7c3aed] hover:underline font-semibold">
          ...
          <ul className="space-y-2 text-sm text-[#475569]">
            {[
              ...
              <li key={i} className="flex items-start gap-2">
                <svg className="w-4 h-4 text-[#7c3aed] shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
