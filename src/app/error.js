  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-20 sm:px-6 lg:py-28">
      <div className="text-center">
        ...
        {/* Headline */}
        <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-[#1d1a33] mb-3" style={{ fontFamily: "var(--font-heading)", fontWeight: 800 }}>
          Something went wrong
        </h1>
        <p className="text-lg text-[#5d5a78] max-w-lg mx-auto mb-2" style={{ fontFamily: "var(--font-body)", fontWeight: 300 }}>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-16">
          <button
            onClick={() => reset()}
            className="inline-flex items-center gap-2 rounded-[100px] bg-[#1d1a33] text-white font-semibold px-6 py-3 text-base hover:bg-[#7c3aed] hover:-translate-y-[2px] hover:shadow-[0_8px_32px_rgba(124,58,237,0.3)] transition-all cursor-pointer"
        ...
        {/* Support Info */}
        <div className="border-t border-[#e7e5f3] pt-10">
          <p className="text-sm text-[#5d5a78] mb-4" style={{ fontFamily: "var(--font-body)", fontWeight: 300 }}>
