...
const calculators = [
  // NEW CALCULATORS — July 4, 2026: foundational cluster (shown first under "New")
  { href: "/calculators/compound-interest-calculator", title: "Compound Interest Calculator", desc: "See how your savings and investments grow over time with compound interest and regular monthly contributions.", icon: "📈", tag: "New" },
  { href: "/calculators/salary-to-hourly-calculator", title: "Salary to Hourly Calculator", desc: "Convert any annual salary into an equivalent hourly, daily, weekly, and monthly wage instantly.", icon: "💵", tag: "New" },
  { href: "/calculators/federal-income-tax-calculator-2026", title: "Federal Income Tax Calculator", desc: "Estimate your 2026 federal income tax, effective and marginal rates, take-home pay, and refund with the latest IRS brackets.", icon: "🧾", tag: "New" },
  { href: "/calculators/effective-tax-rate-calculator", title: "Effective Tax Rate Calculator", desc: "Find your true effective tax rate — the actual percentage you pay — across federal, FICA, and state taxes.", icon: "📊", tag: "New" },
  { href: "/calculators/hsa-tax-savings-calculator", title: "HSA Tax Savings Calculator", desc: "See income tax and FICA savings from HSA contributions — the only triple-tax-advantaged account. 2026 limits.", icon: "🏥", tag: "New" },
  { href: "/calculators/rent-vs-buy-calculator", title: "Rent vs Buy Calculator", desc: "Compare the true total cost of renting versus buying a home over time, including equity, appreciation, and opportunity cost.", icon: "🏘️", tag: "New" },
  { href: "/calculators/heloc-calculator", title: "HELOC Calculator", desc: "Find how much you can borrow against your home equity, plus interest-only draw and full repayment payments.", icon: "🏠", tag: "New" },
  { href: "/calculators/fire-calculator", title: "FIRE Calculator", desc: "Find your FIRE number, years to financial independence, and Coast FIRE target based on your savings rate and expenses.", icon: "🔥", tag: "New" },
  { href: "/calculators/debt-snowball-vs-avalanche-calculator", title: "Debt Snowball vs Avalanche Calculator", desc: "Compare both debt payoff strategies side by side to see which clears your debt faster and saves the most interest.", icon: "❄️", tag: "New" },
  { href: "/calculators/rmd-calculator-2026", title: "RMD Calculator", desc: "Calculate your 2026 Required Minimum Distribution from IRAs and 401(k)s using the IRS Uniform Lifetime Table.", icon: "🏦", tag: "New" },
  { href: "/calculators/poshmark-fee-calculator", title: "Poshmark Fee Calculator", desc: "See exactly what Poshmark takes — $2.95 flat under $15 or 20% commission — and your true payout and profit on every sale.", icon: "👗", tag: "Marketplace" },
  { href: "/calculators/mercari-fee-calculator", title: "Mercari Fee Calculator", desc: "Calculate Mercari's flat 10% selling fee (no processing charge since 2025) and your exact payout and profit on any sale.", icon: "🛍️", tag: "Marketplace" },
  { href: "/calculators/depop-fee-calculator", title: "Depop Fee Calculator", desc: "Depop dropped its US selling fee — just 3.3% + $0.45 processing (plus optional 12% boost). See your exact payout.", icon: "🧥", tag: "Marketplace" },
  { href: "/calculators/whatnot-fee-calculator", title: "Whatnot Fee Calculator", desc: "Live selling fees decoded: 8% commission + 2.9% + $0.30 processing. See your true payout per sale and per stream.", icon: "📺", tag: "Marketplace" },
  { href: "/calculators/stockx-fee-calculator", title: "StockX Fee Calculator", desc: "StockX seller fees by level (8–9.5% + 3% processing), shipping bonuses, and your true payout on sneakers and collectibles.", icon: "👟", tag: "Marketplace" },
  { href: "/calculators/facebook-marketplace-fee-calculator", title: "Facebook Marketplace Fee Calculator", desc: "Shipped orders pay 10% ($0.80 min); local pickup is free. Compare both and see your exact payout.", icon: "🏪", tag: "Marketplace" },
  { href: "/calculators/onlyfans-tax-calculator", title: "OnlyFans Tax Calculator", desc: "Estimate SE tax, federal tax, and quarterly payments on OnlyFans income — with the 20% platform fee deducted correctly.", icon: "📱", tag: "Self-Employment" },
  { href: "/calculators/creator-tax-calculator", title: "Content Creator Tax Calculator", desc: "YouTube, Twitch, TikTok, and sponsorship income — estimate SE tax, federal tax, and what to set aside quarterly.", icon: "🎬", tag: "Self-Employment" },
  { href: "/calculators/turo-profit-calculator", title: "Turo Profit Calculator", desc: "Estimate real Turo host income — 70/80/90% earnings plan share minus car payment and running costs, monthly and annually.", icon: "🚗", tag: "Automotive" },
  { href: "/calculators/instacart-tax-calculator", title: "Instacart Tax Calculator", desc: "Shopper taxes with the $0.725/mile deduction and the new OBBBA tips deduction for delivery drivers. Includes quarterly amounts.", icon: "🛒", tag: "Gig Economy" },
  { href: "/calculators/no-tax-on-tips-calculator-2026", title: "No Tax on Tips Calculator", desc: "Estimate your federal tax savings from the OBBBA $25,000 qualified tips deduction. W-2 and self-employed tipped workers, with phase-out limits.", icon: "💵", tag: "Tax Tools" },
  { href: "/calculators/car-loan-interest-deduction-calculator-2026", title: "Car Loan Interest Deduction Calculator", desc: "Deduct up to $10,000 of interest on new US-assembled vehicles under OBBBA — real amortization math and MAGI phase-outs.", icon: "🚙", tag: "Auto & Loans" },
  { href: "/calculators/senior-tax-deduction-calculator-2026", title: "Senior Tax Deduction Calculator", desc: "Estimate the $6,000 OBBBA bonus deduction for age 65+ ($12,000 for couples), the 6% phase-out, and your total tax-free income.", icon: "👴", tag: "Retirement" },
  { href: "/calculators/social-security-tax-calculator", title: "Social Security Tax Calculator", desc: "Find how much of your Social Security benefits are taxable under the IRS 0%, 50%, and 85% combined-income rules.", icon: "🧓", tag: "Retirement" },
  { href: "/calculators/obbba-tax-savings-calculator", title: "OBBBA Tax Savings Calculator", desc: "Stack all four One Big Beautiful Bill deductions — tips, overtime, senior bonus, and car loan interest — in one place.", icon: "🏛️", tag: "Tax Tools" },
  { href: "/calculators/no-tax-on-overtime-calculator-2026", title: "No Tax on Overtime Calculator", desc: "Estimate your federal income tax savings on overtime pay under the OBBBA deduction for 2026. W-2 employees only, with phase-out limits.", icon: "⏱️", tag: "Tax Tools" },
  { href: "/calculators/freelancer-platform-fee-calculator-2026", title: "Freelancer Platform Fee Calculator", desc: "Compare your real take-home pay after Fiverr, Upwork, Toptal, Contra, and PeoplePerHour fees. Free 2026 freelancer fee comparison.", icon: "💼", tag: "Freelancing" },
  { href: "/calculators/break-even-calculator-small-business", title: "Break-Even Calculator", desc: "Find how many units you need to sell to cover fixed and variable costs, with contribution margin analysis for small business and e-commerce.", icon: "⚖️", tag: "Self-Employment" },
  { href: "/calculators/tiktok-shop-earnings-calculator-2026", title: "TikTok Shop Earnings Calculator", desc: "Estimate your net TikTok Shop earnings after referral fees, affiliate commissions, COGS, and shipping. Built for TikTok sellers and creators.", icon: "🎵", tag: "E-Commerce" },
  { href: "/calculators/w2-vs-1099-calculator-2026", title: "W-2 vs 1099 Calculator", desc: "Compare your real take-home pay as a W-2 employee versus a 1099 independent contractor. Includes SE tax, QBI, benefits value, and break-even rate.", icon: "🧾", tag: "Tax Tools" },
