...
const calculators = [
  // NEW CALCULATORS — July 4, 2026: OBBBA cluster (shown first under the "New" category)
  { href: "/calculators/no-tax-on-tips-calculator-2026", title: "No Tax on Tips Calculator", desc: "Estimate your federal tax savings from the OBBBA $25,000 qualified tips deduction. W-2 and self-employed tipped workers, with phase-out limits.", icon: "💵", tag: "New" },
  { href: "/calculators/car-loan-interest-deduction-calculator-2026", title: "Car Loan Interest Deduction Calculator", desc: "Deduct up to $10,000 of interest on new US-assembled vehicles under OBBBA — real amortization math and MAGI phase-outs.", icon: "🚙", tag: "New" },
  { href: "/calculators/senior-tax-deduction-calculator-2026", title: "Senior Tax Deduction Calculator", desc: "Estimate the $6,000 OBBBA bonus deduction for age 65+ ($12,000 for couples), the 6% phase-out, and your total tax-free income.", icon: "👴", tag: "New" },
  { href: "/calculators/social-security-tax-calculator", title: "Social Security Tax Calculator", desc: "Find how much of your Social Security benefits are taxable under the IRS 0%, 50%, and 85% combined-income rules.", icon: "🧓", tag: "New" },
  { href: "/calculators/obbba-tax-savings-calculator", title: "OBBBA Tax Savings Calculator", desc: "Stack all four One Big Beautiful Bill deductions — tips, overtime, senior bonus, and car loan interest — in one place.", icon: "🏛️", tag: "New" },
