...
const calculators = [
  ...
  { href: "/calculators/poshmark-fee-calculator", title: "Poshmark Fee Calculator", desc: "See exactly what Poshmark takes — $2.95 flat under $15 or 20% commission — and your true payout and profit on every sale.", icon: "👗", tag: "New" },
  { href: "/calculators/mercari-fee-calculator", title: "Mercari Fee Calculator", desc: "Calculate Mercari's flat 10% selling fee (no processing charge since 2025) and your exact payout and profit on any sale.", icon: "🛍️", tag: "New" },
  { href: "/calculators/depop-fee-calculator", title: "Depop Fee Calculator", desc: "Depop dropped its US selling fee — just 3.3% + $0.45 processing (plus optional 12% boost). See your exact payout.", icon: "🧥", tag: "New" },
  { href: "/calculators/whatnot-fee-calculator", title: "Whatnot Fee Calculator", desc: "Live selling fees decoded: 8% commission + 2.9% + $0.30 processing. See your true payout per sale and per stream.", icon: "📺", tag: "New" },
  { href: "/calculators/stockx-fee-calculator", title: "StockX Fee Calculator", desc: "StockX seller fees by level (8–9.5% + 3% processing), shipping bonuses, and your true payout on sneakers and collectibles.", icon: "👟", tag: "New" },
  { href: "/calculators/facebook-marketplace-fee-calculator", title: "Facebook Marketplace Fee Calculator", desc: "Shipped orders pay 10% ($0.80 min); local pickup is free. Compare both and see your exact payout.", icon: "🏪", tag: "New" },
  { href: "/calculators/onlyfans-tax-calculator", title: "OnlyFans Tax Calculator", desc: "Estimate SE tax, federal tax, and quarterly payments on OnlyFans income — with the 20% platform fee deducted correctly.", icon: "📱", tag: "New" },
  { href: "/calculators/creator-tax-calculator", title: "Content Creator Tax Calculator", desc: "YouTube, Twitch, TikTok, and sponsorship income — estimate SE tax, federal tax, and what to set aside quarterly.", icon: "🎬", tag: "New" },
  { href: "/calculators/turo-profit-calculator", title: "Turo Profit Calculator", desc: "Estimate real Turo host income — 70/80/90% earnings plan share minus car payment and running costs, monthly and annually.", icon: "🚗", tag: "New" },
  { href: "/calculators/instacart-tax-calculator", title: "Instacart Tax Calculator", desc: "Shopper taxes with the $0.725/mile deduction and the new OBBBA tips deduction for delivery drivers. Includes quarterly amounts.", icon: "🛒", tag: "New" },
