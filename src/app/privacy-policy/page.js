...
export const metadata = {
  ...
  description:
    "CalcMetric privacy policy — how we handle your data, cookies, Google AdSense, analytics, and your rights as a user.",
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:py-16">
      ...
      <div className="rounded-2xl border border-[#E2E8F0] bg-white p-6 sm:p-10 shadow-sm">
        <article className="seo-content">
          <h2>Introduction</h2>
          <p>
            CalcMetric (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is committed to protecting your privacy.
            This Privacy Policy explains how we collect, use, disclose, and safeguard your
            information when you visit our website at{" "}
            <strong>https://calcmetric.com</strong> (the &quot;Site&quot;). Please read this policy
          ...
          <ul>
            <li>
              <strong>Email:</strong>{" "}
              <a
                href="mailto:privacy@calcmetric.com"
                className="text-[#0D9488] hover:text-[#0F766E] underline"
              >
                privacy@calcmetric.com
              </a>
            </li>
            <li>
