  ...
  return (
    <footer className="bg-[#1A1410] text-white transition-colors duration-300">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">        {/* Newsletter */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 border-b border-[#2A2420] pb-12 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-[#8A7F72]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300 }}>
              ...
              <li><Link href="/calculators/doordash-tax-estimator" className="hover:text-white/70 transition-colors">DoorDash Driver Tax</Link></li>
              <li><Link href="/calculators/side-hustle-tax-calculator" className="hover:text-white/70 transition-colors">Side Hustle Tax</Link></li>
              <li><Link href="/calculators/texas-paycheck-calculator" className="hover:text-white/70 transition-colors">Texas Paycheck</Link></li>
          ...
          {/* Column 3: Business */}
          <div>
            <h4 className="text-sm font-bold text-[#E8521A] uppercase tracking-wider mb-4" style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 600 }}>Business Tools</h4>
            <ul className="space-y-2.5 text-sm text-[#8A7F72]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300 }}>
              ...
              <li><Link href="/calculators/ecommerce-net-profit-margin" className="hover:text-white/70 transition-colors">E-Commerce Profit Margin</Link></li>
