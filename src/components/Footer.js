...
export default function Footer() {
  return (
    <footer className="bg-[#0F172A] text-white border-t border-[#1E293B] dark:bg-[#060B16] dark:border-[#1E293B] transition-colors duration-300">
      {/* Mega Footer Columns */}
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 border-b border-[#1E293B] pb-12 mb-10">
          ...
          <div className="col-span-2 space-y-4">
            <Link href="/" className="flex items-center gap-2.5 group">
              ...
              <span className="text-xl font-extrabold tracking-tight">
                The<span className="text-[#0D9488] dark:text-[#14B8A6]">Metric</span>App
              </span>
            </Link>
            ...
            <div className="flex gap-4.5 text-xs text-[#64748B] pt-2">
              <span className="font-semibold text-teal-500 dark:text-[#14B8A6] uppercase tracking-widest">100% Free</span>
              <span>•</span>
              <span className="font-semibold text-teal-500 dark:text-[#14B8A6] uppercase tracking-widest">No Sign-Up Required</span>
            </div>
          </div>

          {/* Column 2: Tax Calculators */}
          <div>
            <h4 className="text-sm font-bold text-teal-400 dark:text-[#14B8A6] uppercase tracking-wider mb-4">
              Tax Tools
            </h4>
            <ul className="space-y-2.5 text-sm text-[#94A3B8]">
              ...
              <li>
                <Link href="/calculators/self-employment-tax-calculator-2026" className="hover:text-white transition-colors">
                  Self Employment Tax
                </Link>
              </li>
              <li>
                <Link href="/calculators/uber-tax-calculator-2026" className="hover:text-white transition-colors">
                  Uber Tax
                </Link>
              </li>
              <li>
                <Link href="/calculators/small-business-tax-deduction-calculator" className="hover:text-white transition-colors">
                  Small Business Tax
                </Link>
              </li>
              <li>
                <Link href="/calculators/home-affordability-calculator-2026" className="hover:text-white transition-colors">
                  Home Affordability
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-[#94A3B8]">
              ...
              <li>
                <Link href="/calculators/etsy-fee-calculator-2026" className="hover:text-white transition-colors">
                  Etsy Fee
                </Link>
              </li>
              <li>
                <Link href="/calculators/shopify-profit-calculator-2026" className="hover:text-white transition-colors">
                  Shopify Profit
                </Link>
              </li>
              <li>
                <Link href="/calculators/amazon-seller-fee-calculator-2026" className="hover:text-white transition-colors">
                  Amazon Seller Fee
                </Link>
              </li>
              <li>
                <Link href="/calculators/gig-economy-net-income-calculator" className="hover:text-white transition-colors">
                  Gig Economy Income
                </Link>
              </li>
              <li>
                <Link href="/calculators/credit-card-payoff-calculator" className="hover:text-white transition-colors">
                  Credit Card Payoff
                </Link>
              </li>
              <li>
                <Link href="/calculators/student-loan-payoff-calculator" className="hover:text-white transition-colors">
                  Student Loan Payoff
                </Link>
              </li>
            </ul>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-[#64748B]">
          ...
          <div className="flex gap-4 shrink-0">
            <Link href="/terms" className="hover:text-teal-400 dark:hover:text-[#14B8A6] transition-colors">
              Terms of Service
            </Link>
            <Link href="/privacy-policy" className="hover:text-teal-400 dark:hover:text-[#14B8A6] transition-colors">
              Privacy Policy
            </Link>
          </div>
        </div>
