const categoryStyles = {
  ...
  "Gig Economy": { gradient: "from-violet-500/20 to-violet-500/5", emoji: "🚗", color: "#7c3aed", bg: "rgba(124,58,237,0.18)" },
  ...
  "Loans": { gradient: "from-violet-400/20 to-violet-400/5", emoji: "💰", color: "#7c3aed", bg: "rgba(124,58,237,0.18)" },
  "Loans & Credit": { gradient: "from-violet-400/20 to-violet-400/5", emoji: "💰", color: "#7c3aed", bg: "rgba(124,58,237,0.18)" },
  "Auto & Loans": { gradient: "from-slate-500/20 to-slate-500/5", emoji: "🚘", color: "#475569", bg: "rgba(71,85,105,0.18)" },
};

const defaultStyle = { gradient: "from-[#7c3aed]/20 to-[#7c3aed]/5", emoji: "📊", color: "#7c3aed", bg: "rgba(124,58,237,0.18)" };
