/** Rich SEO content for the UK Hourly to Annual Salary Calculator */

export const hourlyToAnnualSalaryUkSeo = {
  calculatorName: "Hourly to Annual Salary Calculator UK",
  topic: "Hourly to Annual Salary Conversion",
  howToUse:
    "Enter your hourly pay rate in pounds, then add your contracted hours per week and any regular overtime. Select how many weeks you work each year — most full-time UK employees use 52 weeks, while 46 weeks accounts for statutory holiday. The calculator instantly shows your annual gross salary, monthly and weekly equivalents, overtime uplift, holiday pay adjustment, and your effective hourly rate after overtime is included.",
  whatIs:
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "There is no single statutory overtime multiplier in UK law — your contract or sector agreement sets the rate, commonly 1.25× (time and a quarter) or 1.5× (time and a half) for hours beyond your normal working week. Some employers pay plain time for additional hours. Enter your overtime hours and multiplier above to see how enhanced pay lifts your annual gross salary and effective hourly rate across the full tax year.",
    },
    {
      q: "Does statutory holiday pay affect my annual salary calculation?",
      a: "Yes. UK workers are entitled to 5.6 weeks of paid holiday per year (28 days for a five-day week, including bank holidays if your employer counts them). If your hourly rate already includes rolled-up holiday pay, use 52 working weeks. If holiday is paid on top of hours worked, selecting 46 working weeks plus separate holiday pay gives a more accurate annual figure for budgeting and mortgage affordability checks.",
    },
  ],
};
