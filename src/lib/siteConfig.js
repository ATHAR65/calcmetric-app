...
export const calculators = [
  ...
  // NEW CALCULATORS — July 4, 2026: foundational cluster (shown first under "New")
  {
    ...
    desc: "See how your savings and investments grow over time with compound interest and regular monthly contributions.",
    icon: "📈",
    tag: "New",
  },
  {
    ...
    desc: "Convert any annual salary into an equivalent hourly, daily, weekly, and monthly wage instantly.",
    icon: "💵",
    tag: "New",
  },
  {
    href: "/calculators/federal-income-tax-calculator-2026",
    title: "Federal Income Tax Calculator",
    desc: "Estimate your 2026 federal income tax, effective and marginal rates, take-home pay, and refund with the latest IRS brackets.",
    icon: "🧾",
    tag: "New",
  },
  {
    href: "/calculators/effective-tax-rate-calculator",
    title: "Effective Tax Rate Calculator",
    desc: "Find your true effective tax rate — the actual percentage you pay — across federal, FICA, and state taxes.",
    icon: "📊",
    tag: "New",
  },
  {
    href: "/calculators/hsa-tax-savings-calculator",
    title: "HSA Tax Savings Calculator",
    desc: "See income tax and FICA savings from HSA contributions — the only triple-tax-advantaged account. 2026 limits.",
    icon: "🏥",
    tag: "New",
  },
  {
    ...
    desc: "Compare the true total cost of renting versus buying a home over time, including equity, appreciation, and opportunity cost.",
    icon: "🏘️",
    tag: "New",
  },
  {
    ...
    desc: "Find how much you can borrow against your home equity, plus interest-only draw and full repayment payments.",
    icon: "🏠",
    tag: "New",
  },
  {
    ...
    desc: "Find your FIRE number, years to financial independence, and Coast FIRE target based on your savings rate and expenses.",
    icon: "🔥",
    tag: "New",
  },
  {
    ...
    desc: "Compare both debt payoff strategies side by side to see which clears your debt faster and saves the most interest.",
    icon: "❄️",
    tag: "New",
  },
  {
    href: "/calculators/rmd-calculator-2026",
    title: "RMD Calculator",
    desc: "Calculate your 2026 Required Minimum Distribution from IRAs and 401(k)s using the IRS Uniform Lifetime Table.",
    icon: "🏦",
    tag: "New",
  },
  // July 4, 2026 — marketplace & creator cluster (moved from "New" to real categories)
  {
